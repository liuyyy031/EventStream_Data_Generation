"""STPP v15 prompt routing with fail-closed Judge response handling."""
...
class DeclaredRouteJudgeNetworkSTPPGenerator(SafeJudgeNetworkSDEGenerator):
    """Route Agent 1, Agent 2, and Judge through the v15 prompt copies."""
    ...
    def parse_scenario_to_structured_json(
        ...
        _base_module.SCENARIO_PARSING_PROMPT = STPP_V15_SCENARIO_PARSING_PROMPT
        try:
