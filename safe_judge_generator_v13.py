"""STPP v13 prompt routing with the v12 Judge response invariants."""
...
class SpatiallyGroundedJudgeNetworkSTPPGenerator(SafeJudgeNetworkSDEGenerator):
    """Route all three agent stages through the versioned v13 prompts."""
    ...
    def parse_scenario_to_structured_json(
        ...
        _base_module.SCENARIO_PARSING_PROMPT = STPP_V13_SCENARIO_PARSING_PROMPT
        try:
