#!/usr/bin/env python3
"""Parallel batch driver for the graph-conditioned STPP v2 branch."""
...
def _generate_one(
    ...
    from demo_sts_stpp_v2 import demo_stpp_generation_v2
    from stpp_adapter_v2 import STPPV2Config
    ...
    dst_pkl = os.path.join(
        out_dir, f"task_{idx:04d}_{_slug(domain)}_n{num_nodes}_stpp_v2.pkl"
    )
...
def main() -> int:
    ...
    parser.add_argument(
        "--out_dir",
        default=os.path.join("data_generation", "batch_output_stpp_v2"),
    )
