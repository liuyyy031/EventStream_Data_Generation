"""STPP v16 prompt routing with evidence-based fail-closed Judge handling."""
...
class FailClosedRouteJudgeNetworkSTPPGenerator(SafeJudgeNetworkSDEGenerator):
    """Route Agent 1, Agent 2, and Judge through the v16 prompt copies."""
    ...
    def parse_scenario_to_structured_json(
        ...
        _base_module.SCENARIO_PARSING_PROMPT = STPP_V16_SCENARIO_PARSING_PROMPT
        try:
